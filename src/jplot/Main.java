...
//            {
            ...
            JFrame frame = new Main().initGUI();      
            JPanel content = new Main().initPanel();
            Main.sendGUI(XSIZE,YSIZE,amp,omega, phi,SCALE,PRECISION,SUM,CHOICE,content);
            Main.displayGUI(frame,content,XSIZE,YSIZE);
